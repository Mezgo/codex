export function filterSignals(signals, { query = "", source = "all", sourceCategory = "all", days = "all", now = new Date("2026-08-05T00:00:00Z") } = {}) {
  ...
  return signals.filter((signal) => {
    ...
    const matchesCategory = sourceCategory === "all" || signal.sourceCategory === sourceCategory;
